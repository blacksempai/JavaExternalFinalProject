...
<div class="content"><br>
    <div>
    <p><b>Обзор: <i style="color:red;">${report.review}</i></b></p>
    </div>
        ...
        <td>
            <table style="width: 100%;" border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td style="text-align: right;" valign="bottom"><input value="${report.reportBody.info.year}" name="zvitnrik" style="padding: 3px; -moz-appearance: textfield; background-color: #f4e4b8; margin: 2px; width: 60px; border: 1px solid #888888;" type="number"/></td>
        ...
        <td>
            <table style="width: 100%;" border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td style="text-align: right;" valign="bottom"><input value="${report.reportBody.info.specifiedYear}" name="zvitnrik_utochn" style="padding: 3px; -moz-appearance: textfield; background-color: #f4e4b8; margin: 2px; width: 60px; border: 1px solid #888888;" onkeyup="this.value = this.value.replace(/\D/g, '')" onkeyup="this.value = this.value.replace(/\D/g, '')" type="number" value="" /></td>
                    <td valign="bottom">&nbsp;року</td>
                </tr>
                <tr>
                    <td>(необхідне позначити)</td>
...
<table style="width: 100%; margin-bottom: 4px;" border="1" cellspacing="0" cellpadding="2">
    ...
    <tr>
        ...
        <td><input value="${report.reportBody.info.authorityName}" name="nazva_dpi" style="background-color: #f4e4b8; margin: 2px; width: 550px; border: 1px  solid #888888;" type="text" /></td>
    </tr>
    </tbody>
</table>
...
<table style="width: 100%;" border="1" cellspacing="0" cellpadding="2">
    ...
    <tr>
        ...
        <td style="width: 70px;"><input value="${report.reportBody.general.employeesNumber}" name="chiselnist" style="padding: 3px; -moz-appearance: textfield; background-color: #f4e4b8; margin: 2px; width: 60px; border: 1px solid #888888;"  type="number"/></td>
    </tr>
    <tr>
    ...
    <tr>
     ...
     <c:forEach var="a" items="${report.reportBody.general.activities}" varStatus="i">
            <tr>
                <td><input value="${a.code}" name="kodkved${i.count}" style="background-color: #f4e4b8; margin: 2px; width: 50px; border: 1px  solid #888888;" type="text" /></td>
                <td colspan="2"><input value="${a.name}" name="nazvakved${i.count}" style="background-color: #f4e4b8; margin: 2px; width: 550px; border: 1px  solid #888888;" type="text" /></td>
            </tr>
     </c:forEach>
    </tbody>
</table>
...
<table style="width: 100%;" border="1" cellpadding="2" cellspacing="0">
    ...
    <tr>
        <td style="text-align: center;"><input value="${report.reportBody.firstGroup.firstQuarter}" name="gr1_kv1" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
            </td>
        <td style="text-align: center;"><input value="${report.reportBody.firstGroup.secondQuarter}" name="gr1_kv2" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
            </td>
        <td style="text-align: center;"><input value="${report.reportBody.firstGroup.thirdQuarter}" name="gr1_kv3" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
            </td>
        <td style="text-align: center;"><input value="${report.reportBody.firstGroup.forthQuarter}" name="gr1_kv4" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
            </td>
    </tr>
    </tbody>
</table>
<table style="width: 100%;" border="1" cellspacing="0" cellpadding="2">
    ...
    <tr>
        ...
        <td style="text-align: center;"><input value="${report.reportBody.firstGroup.incomeVolume01}" name="rd01" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
            </td>
    </tr>
    <tr>
        ...
        <td style="text-align: center;"><input value="${report.reportBody.firstGroup.taxedIncomeVolume02}" name="rd02" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
            </td>
    </tr>
    </tbody>
</table>
...
<table style="width: 100%;" border="1" cellpadding="2" cellspacing="0">
    ...
    <tr>
        <td style="text-align: center;"><input value="${report.reportBody.secondGroup.firstQuarter}" name="gr2_kv1" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
            </td>
        <td style="text-align: center;"><input value="${report.reportBody.secondGroup.secondQuarter}" name="gr2_kv2" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
           </td>
        <td style="text-align: center;"><input value="${report.reportBody.secondGroup.thirdQuarter}" name="gr2_kv3" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
        </td>
        <td style="text-align: center;"><input value="${report.reportBody.secondGroup.forthQuarter}" name="gr2_kv4" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
        </td>
    </tr>
    </tbody>
</table>
<table style="width: 100%;" border="1" cellspacing="0" cellpadding="2">
    ...
    <tr>
        ...
        <td style="text-align: center;"><input value="${report.reportBody.secondGroup.incomeVolume03}" name="rd03" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
            </td>
    </tr>
    <tr>
        <td>Обсяг доходу, що оподаткований за ставкою 15 відсотків (згідно з пунктом 293.4 статті 293 глави 1 розділу XIV Податкового кодексу України), у звітному (податковому) періоді<sup>4</sup></td>
        <td style="text-align: center;">04</td>
        <td style="text-align: center;"><input value="${report.reportBody.secondGroup.taxedIncomeVolume04}" name="rd04" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
            </td>
    </tr>
    </tbody>
</table>
...
<table style="width: 100%;" border="1" cellspacing="0" cellpadding="2">
    ...
    <tr>
        ...
        <td style="text-align: center;"><input value="${report.reportBody.thirdGroup.threePercentTaxed05}" name="rd05" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
           </td>
    </tr>
    <tr>
        <td>Обсяг доходу за звітний (податковий) період, що оподатковується за ставкою 5 %</td>
        <td style="text-align: center;">06</td>
        <td style="text-align: center;"><input value="${report.reportBody.thirdGroup.fivePercentTaxed06}" name="rd06" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
            </td>
    </tr>
    <tr>
        <td>Обсяг доходу, що оподаткований за ставкою 15 відсотків (згідно з пунктом 293.4 статті 293 глави 1 розділу XIV Податкового кодексу України), у звітному (податковому) періоді<sup>4</sup></td>
        <td style="text-align: center;">07</td>
        <td style="text-align: center;"><input value="${report.reportBody.thirdGroup.fifteenPercentTaxed07}" name="rd07" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
            </td>
    </tr>
    </tbody>
</table>
...
<table style="width: 100%;" border="1" cellspacing="0" cellpadding="2">
    ...
    <tr>
        ...
        <td style="text-align: center;"><input value="${summary.totalIncome}" readonly/></td>
    </tr>
    <tr>
        <td>Сума податку за ставкою 15 % ((рядок 02 + рядок 04 + рядок 07) × 15%)</td>
        <td style="text-align: center;">09</td>
        <td style="text-align: center;"><input value="${summary.sum15}" readonly/></td>
    </tr>
    <tr>
        <td>Сума податку за ставкою 3 % (рядок 05 × 3 %)</td>
        <td style="text-align: center;">10</td>
        <td style="text-align: center;"><input value="${summary.sum3}"  readonly/></td>
    </tr>
    <tr>
        <td>Сума податку за ставкою 5 % (рядок 06 × 5 %)</td>
        <td style="text-align: center;">11</td>
        <td style="text-align: center;"><input value="${summary.sum5}"  readonly/></td>
    </tr>
    <tr>
        <td>Нараховано всього за звітний (податковий) період (рядок 9 + рядок 10 + рядок 11)</td>
        <td style="text-align: center;">12</td>
        <td style="text-align: center;"><input value="${summary.totalSum}" readonly/></td>
    </tr>
    <tr>
        ...
        <td> <input value="${summary.previousTotalSum}" readonly/> </td>
    </tr>
    <tr>
        ...
        <td style="text-align: center;"><input value="${summary.taxSum}" readonly/></td>
    </tr>
    </tbody>
</table>
...
<table style="width: 100%;" border="1" cellspacing="0" cellpadding="2">
    ...
    <tr>
        ...
        <td style="text-align: center;"><input value="${report.reportBody.errorReport.singleTax15}" name="rd15" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
           </td>
    </tr>
    <tr>
        <td>Уточнена сума податкових зобов'язань за звітний (податковий) період, у якому виявлена помилка</td>
        <td style="text-align: center;">16</td>
        <td style="text-align: center;"><input value="${report.reportBody.errorReport.specifiedTax16}" name="rd16" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
            </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="text-align: center;"><input value="${summary.amountIncrease}" readonly/></td>
    </tr>
    <tr>
        <td>Зменшення суми, яка підлягала перерахуванню до бюджету<sup>7</sup><br />(рядок 16 - рядок 15, якщо рядок 16 &lt; рядка 15)</td>
        <td style="text-align: center;">18</td>
        <td style="text-align: center;"><input value="${summary.amountDecrease}" readonly/></td>
    </tr>
    <tr>
        <td><span>Сума штрафу, яка нарахована платником податку самостійно у зв'язку з виправленням помилки, </span>

            <input value="${report.reportBody.errorReport.finePercent}" type="number" name="rd19dod" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px; -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 30px;" />



            <span>% (рядок 17 × 3 % або 17 × 5 %)<sup>8</sup></span></td>
        <td style="text-align: center;">19</td>
        <td style="text-align: center;"><input value="${summary.fineAmount}" readonly/></td>
    </tr>
    <tr>
        ...
        <td style="text-align: center;"><input value="${report.reportBody.errorReport.pennySum20}" name="rd20" style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px;  -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 80px;"/>
            </td>
    </tr>
    </tbody>
</table>
