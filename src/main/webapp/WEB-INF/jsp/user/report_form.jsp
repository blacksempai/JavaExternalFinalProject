        ...
        <td>
            <table style="width: 100%;" border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td style="text-align: right;" valign="bottom"><input name="zvitnrik" style="padding: 3px; -moz-appearance: textfield; background-color: #f4e4b8; margin: 2px; width: 60px; border: 1px solid #888888;" onkeyup="this.value = this.value.replace(/\D/g, '')" onkeyup="this.value = this.value.replace(/\D/g, '')" type="number" value="2019" /></td>
        ...
        <td>
            <table style="width: 100%;" border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td style="text-align: right;" valign="bottom"><input name="zvitnrik_utochn" style="padding: 3px; -moz-appearance: textfield; background-color: #f4e4b8; margin: 2px; width: 60px; border: 1px solid #888888;" onkeyup="this.value = this.value.replace(/\D/g, '')" onkeyup="this.value = this.value.replace(/\D/g, '')" type="number" value="" /></td>
                    <td valign="bottom">&nbsp;року</td>
                </tr>
                <tr>
                    <td>(необхідне позначити)</td>
...
<table style="width: 100%;" border="1" cellspacing="0" cellpadding="2">
    ...
    <tr>
        ...
        <td style="width: 70px;"><input name="chiselnist" style="padding: 3px; -moz-appearance: textfield; background-color: #f4e4b8; margin: 2px; width: 60px; border: 1px solid #888888;" onkeyup="this.value = this.value.replace(/\D/g, '')" onkeyup="this.value = this.value.replace(/\D/g, '')" type="number" value="0" /></td>
    </tr>
    <tr>
...
<table style="width: 100%;" border="1" cellspacing="0" cellpadding="2">
    ...
    <tr>
        <td><span>Сума штрафу, яка нарахована платником податку самостійно у зв'язку з виправленням помилки, </span>
            ...
            <input onkeyup="this.value = this.value.replace(/\D/g, '')" type="number" name="rd19dod" value="0"  style="border-width: 1px; border-style: solid; border-color: #888888; padding: 3px; -moz-appearance: textfield; background-color: #f4e4b8; margin:  2px;  width: 30px;" />
